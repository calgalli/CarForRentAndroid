...
public class LargeItemSingleLineAdapter extends ArrayAdapter<Item> {
    ...
    */
    public LargeItemSingleLineAdapter(Context context, int textViewResourceId, ArrayList<Item> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.large_image_single_line_adapter, null);
        }
