...
public class selectCarCompanyActivity extends Activity implements AsyncResponse {
    ...
    public class carModel {
        ...
        public carModel(String company, String priceH, String priceF, String image) {
    ...
    private ArrayList<carModel> allCars = new ArrayList<carModel>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.carCompnayListView);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(getApplicationContext(), CarRent.class);
                intent.putExtra("selectedCar", selectedCar);
                intent.putExtra("selectedCompany", selectedCompany);
                intent.putExtra("selectedPrice", allCars.get(selectedPos).priceF.replaceAll("\\s+",""));
    ...
    protected void onResume() {
        ...
        allCars.clear();
        Intent x = getIntent();
        selectedCar = x.getStringExtra("selectedCar");
        mTitleTextView.setText(selectedCar);
        String[] loginParameters = {selectedCar};
        sendRequest emailRequest = new sendRequest();
        emailRequest.delegate = selectCarCompanyActivity.this;
        emailRequest.execute(loginParameters);

        Log.i("IN_COMPANY", selectedCar);
        Log.i("SELECTED_CAR", selectedCar);
    }
    ...
    public void processFinishArray(JSONArray output) {
        for(int i = 0;i < output.length();i++){
            try {
                ...
                JSONArray carModels = x.getJSONArray("car");

                for(int j = 0; j < carModels.length(); j++){
                    JSONObject kk = carModels.getJSONObject(j);
                    if(kk.getString("Model").equals(selectedCar)){
                ...
                carModel xmp = new carModel(name,priceH,priceF,logo);
        ...
        ListView listView = (ListView) findViewById(R.id.carCompnayListView);
    ...
    public class sendRequest extends AsyncTask<String, Void, JSONArray> {
        ...
        protected JSONArray doInBackground(String[] params1) {
            ...
            HttpPost get = new HttpPost("https://128.199.97.22:1880/getCarCopanies");
            ...
            nameValuePairs.add(new BasicNameValuePair("car.Model", carModel));
