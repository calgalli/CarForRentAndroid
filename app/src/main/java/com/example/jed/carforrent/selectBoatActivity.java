...
public class selectBoatActivity extends Activity implements AsyncResponse{

    String selectedBoat = "";
    private ArrayList<Item> allCompanies = new ArrayList<Item>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_select_boat);

        ListView listView = (ListView) findViewById(R.id.boatsListView);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                selectedBoat = allCompanies.get(selectedPos).pname;

                Log.i("SELECTED_BOAT", selectedBoat);

                Intent intent = new Intent(getApplicationContext(), selectBoatCompanyActivity.class);
    ...
    protected void onResume() {
        ...
        loginRequest.delegate = selectBoatActivity.this;
    ...
    public void processFinishArray(JSONArray output) {
        for(int i = 0;i < output.length();i++){
            try {
                ...
                Item xmm = new Item( x.getString("Model"),  "/boats/" + x.getString("pic"));
                allCompanies.add(i,xmm);

                Log.i("COMPANY", x.getString("Model"));
        ...
        final LargeItemSingleLineAdapter  arrayAdapter = new LargeItemSingleLineAdapter(this, -1, allCompanies);
        ListView listView = (ListView) findViewById(R.id.boatsListView);
    ...
    public class sendRequest extends AsyncTask<String, Void, JSONArray> {
        ...
        protected JSONArray doInBackground(String[] params1) {
            ...
            HttpPost get = new HttpPost("https://128.199.97.22:1880/getBoats");
