...
public class selectCarActivity extends Activity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                selectedCar = allCompanies.get(selectedPos).pname;

                Log.i("SELECTED_CAR", selectedCar);

                Intent intent = new Intent(getApplicationContext(), selectCarCompanyActivity.class);
    ...
    protected void onResume() {
        ...
        loginRequest.delegate = selectCarActivity.this;
    ...
    public void processFinishArray(JSONArray output) {
        for(int i = 0;i < output.length();i++){
            try {
                ...
                Item xmm = new Item( x.getString("Model"),  "/cars/" + x.getString("pic"));
        ...
        final LargeItemAdapter  arrayAdapter = new LargeItemAdapter(this, -1, allCompanies);
        ListView listView = (ListView) findViewById(R.id.carsListView);
    ...
    public class sendRequest extends AsyncTask<String, Void, JSONArray> {
        ...
        protected JSONArray doInBackground(String[] params1) {
            ...
            HttpPost get = new HttpPost("https://128.199.97.22:1880/getCars");
